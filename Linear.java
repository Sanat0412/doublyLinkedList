class DoublyLinkedList
{
    ...
    // Bubble sort on the given Doubly linked list
    ...
    {
        int arr[] = {22, 76, 66, 45, 3, 25};
        int list_size, i;

        // start with empty linked list
        Node start = null;

        // Create a Doubly linked list from the array arr[].
        //Created Doubly linked list will be 1->11->2->56->12
        for (i = 0; i < 6; i++)
